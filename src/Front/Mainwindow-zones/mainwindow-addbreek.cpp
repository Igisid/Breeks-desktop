...
void MainWindow::setStyleAddBreeksForm() {
  ui->addBreekGB->setStyleSheet("QGroupBox{background: #e8f7cd; border: 1px "
                                "solid #C6C6C6; border-radius: 18px;}");

  ui->breekDescription->setFont(QFont(QStringLiteral("Helvetica"), 12));
  ...
  ui->mnBreekButton->setFont(QFont(QStringLiteral("Helvetica")));
  ui->tuBreekButton->setStyleSheet(dayButtonStyleSheet);
  ui->tuBreekButton->setFont(QFont(QStringLiteral("Helvetica")));
  ui->weBreekButton->setStyleSheet(dayButtonStyleSheet);
  ui->weBreekButton->setFont(QFont(QStringLiteral("Helvetica")));
  ui->thBreekButton->setStyleSheet(dayButtonStyleSheet);
  ui->thBreekButton->setFont(QFont(QStringLiteral("Helvetica")));
  ui->frBreekButton->setStyleSheet(dayButtonStyleSheet);
  ui->frBreekButton->setFont(QFont(QStringLiteral("Helvetica")));
  ui->stBreekButton->setStyleSheet(dayButtonStyleSheet);
  ui->stBreekButton->setFont(QFont(QStringLiteral("Helvetica")));
  ...
  ui->addBreekButton->setStyleSheet(
      "QPushButton{background: #81C4FF; border-radius: 24px; color: #e6f6ff; "
      "font-size: 12pt; font-weight: bold;} "
      "QPushButton:hover{background: #b0d7ff; border-radius: 24px; color: "
      "#e6f6ff; font-size: 12pt; font-weight: bold;}");
}
...
void MainWindow::on_mnBreekButton_clicked() {
  if (arrAddBreekFormDaysCheck_[0] == false) {
    ui->mnBreekButton->setStyleSheet("QPushButton{background: #81C4FF; "
                                     "border-radius: 4px; font-size: 10pt;} "
                                     "QPushButton:hover{background: #e6f6ff; "
                                     "border-radius: 4px; font-size: 10pt;}");
  } else {
    ui->mnBreekButton->setStyleSheet("QPushButton{background: #F7F7F7; "
                                     "border-radius: 4px; font-size: 10pt;} "
                                     "QPushButton:hover{background: #e6f6ff; "
                                     "border-radius: 4px; font-size: 10pt;}");
  }
...
void MainWindow::on_tuBreekButton_clicked() {
  if (arrAddBreekFormDaysCheck_[1] == false) {
    ui->tuBreekButton->setStyleSheet("QPushButton{background: #81C4FF; "
                                     "border-radius: 4px; font-size: 10pt;} "
                                     "QPushButton:hover{background: #e6f6ff; "
                                     "border-radius: 4px; font-size: 10pt;}");
  } else {
    ui->tuBreekButton->setStyleSheet("QPushButton{background: #F7F7F7; "
                                     "border-radius: 4px; font-size: 10pt;} "
                                     "QPushButton:hover{background: #e6f6ff; "
                                     "border-radius: 4px; font-size: 10pt;}");
  }
...
void MainWindow::on_weBreekButton_clicked() {
  if (arrAddBreekFormDaysCheck_[2] == false) {
    ui->weBreekButton->setStyleSheet("QPushButton{background: #81C4FF; "
                                     "border-radius: 4px; font-size: 10pt;} "
                                     "QPushButton:hover{background: #e6f6ff; "
                                     "border-radius: 4px; font-size: 10pt;}");
  } else {
    ui->weBreekButton->setStyleSheet("QPushButton{background: #F7F7F7; "
                                     "border-radius: 4px; font-size: 10pt;} "
                                     "QPushButton:hover{background: #e6f6ff; "
                                     "border-radius: 4px; font-size: 10pt;}");
  }
...
void MainWindow::on_thBreekButton_clicked() {
  if (arrAddBreekFormDaysCheck_[3] == false) {
    ui->thBreekButton->setStyleSheet("QPushButton{background: #81C4FF; "
                                     "border-radius: 4px; font-size: 10pt;} "
                                     "QPushButton:hover{background: #e6f6ff; "
                                     "border-radius: 4px; font-size: 10pt;}");
  } else {
    ui->thBreekButton->setStyleSheet("QPushButton{background: #F7F7F7; "
                                     "border-radius: 4px; font-size: 10pt;} "
                                     "QPushButton:hover{background: #e6f6ff; "
                                     "border-radius: 4px; font-size: 10pt;}");
  }
...
void MainWindow::on_frBreekButton_clicked() {
  if (arrAddBreekFormDaysCheck_[4] == false) {
    ui->frBreekButton->setStyleSheet("QPushButton{background: #81C4FF; "
                                     "border-radius: 4px; font-size: 10pt;} "
                                     "QPushButton:hover{background: #e6f6ff; "
                                     "border-radius: 4px; font-size: 10pt;}");
  } else {
    ui->frBreekButton->setStyleSheet("QPushButton{background: #F7F7F7; "
                                     "border-radius: 4px; font-size: 10pt;} "
                                     "QPushButton:hover{background: #e6f6ff; "
                                     "border-radius: 4px; font-size: 10pt;}");
  }
...
void MainWindow::on_stBreekButton_clicked() {
  if (arrAddBreekFormDaysCheck_[5] == false) {
    ui->stBreekButton->setStyleSheet("QPushButton{background: #81C4FF; "
                                     "border-radius: 4px; font-size: 10pt;} "
                                     "QPushButton:hover{background: #e6f6ff; "
                                     "border-radius: 4px; font-size: 10pt;}");
  } else {
    ui->stBreekButton->setStyleSheet("QPushButton{background: #F7F7F7; "
                                     "border-radius: 4px; font-size: 10pt;} "
                                     "QPushButton:hover{background: #e6f6ff; "
                                     "border-radius: 4px; font-size: 10pt;}");
  }
...
void MainWindow::on_addBreekButton_clicked() {
  ...
  // server request
  QJsonObject json;
  json.insert(QStringLiteral("description"), newElement.text);
  ...
  json.insert(QStringLiteral("states"), QStringLiteral("111111").toShort(&isCovert, 4));

  QJsonArray jArrEmojies;
  for (int i = 0; i < DAYS_COUNT; ++i) {
    QJsonObject jObj;
    jObj.insert(QStringLiteral("emojiNum"), newElement.arrNEmoji[i]);
  ...
  server->sendPostRequestWithBearerToken(url, jsonDoc.toJson(),
